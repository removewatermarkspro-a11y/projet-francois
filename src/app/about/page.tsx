        ...
        <main className="min-h-screen bg-[#FDFBF7]">
            ...
            <Section className="pt-32 pb-20">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <span className="text-[#8F4626] font-sans font-medium tracking-[0.2em] uppercase text-xs mb-4">
                            À Propos
                        </span>
                        <h1 className="text-5xl md:text-6xl font-serif text-[#2C2C2C] mb-8 leading-tight">
                            Mon <span className="italic">Histoire</span>
                        </h1>
                        ...
                        <div className="space-y-6 text-gray-600 font-sans text-lg font-light leading-relaxed">
                            ...
                            <p>
                                Je souhaite amener les personnes que je suis lors de mes séances vers un écoute lucide et bienveillante de leurs besoins. Une approche humble et pertinente sur l’attention que l’on peut porter à son propre corps et à sa détente.
                            </p>
                        </div>
                    </motion.div>
                </div>
            ...
            <Section className="bg-[#EBE9E4] py-20">
                <div className="text-center max-w-4xl mx-auto mb-16">
                    ...
                    <p className="text-gray-600 font-sans text-lg font-light leading-relaxed mb-8">
                    ...
                    <p className="bold text-[#8F4626] font-semibold text-xl">
